...
Module Info.
  ...
  Definition source_file := "server.c".
...
Definition _accept : ident := $"accept".
Definition _bind : ident := $"bind".
...
Definition _sockfd_server : ident := $"sockfd_server".
...
Definition v___stringlit_2 := {|
  ...
  gvar_init := (Init_int8 (Int.repr 48) :: Init_int8 (Int.repr 46) ::
...
Definition v___stringlit_5 := {|
  gvar_info := (tarray tschar 17);
  gvar_init := (Init_int8 (Int.repr 97) :: Init_int8 (Int.repr 99) ::
                Init_int8 (Int.repr 99) :: Init_int8 (Int.repr 101) ::
...
Definition f_main := {|
  ...
  fn_params := nil;
  fn_vars := ((_server, (Tstruct _sockaddr_in noattr)) ::
              (_client, (Tstruct _sockaddr_in noattr)) :: (_len, tuint) ::
              (_buf, (tarray tschar 100)) :: nil);
  fn_temps := ((_sockfd_server, tint) :: (_sockfd_client, tint) ::
               (_k, tint) :: (_t'7, tlong) :: (_t'6, tint) :: (_t'5, tint) ::
...
(Ssequence
  (Ssequence
    (Ssequence
      ...
      (Sset _sockfd_server (Etempvar _t'1 tint)))
    (Ssequence
      (Sifthenelse (Ebinop Oeq (Etempvar _sockfd_server tint)
      ...
      (Ssequence
        (Sassign
          (Efield (Evar _server (Tstruct _sockaddr_in noattr)) _sin_family
        ...
        (Ssequence
          (Ssequence
            ...
            (Sassign
              (Efield
                (Efield (Evar _server (Tstruct _sockaddr_in noattr))
            ...
            (Ssequence
              (Ssequence
                (Scall (Some _t'4)
                  ...
                  ((Etempvar _sockfd_server tint) ::
                   (Ecast
                     (Eaddrof (Evar _server (Tstruct _sockaddr_in noattr))
                ...
                (Sifthenelse (Ebinop One (Etempvar _t'4 tint)
                  ...
                  (Ssequence
                    (Scall None
                      (Evar _puts (Tfunction (Tcons (tptr tschar) Tnil) tint
                                    cc_default))
                      ((Evar ___stringlit_3 (tarray tschar 22)) :: nil))
                    (Sreturn (Some (Econst_int (Int.repr 0) tint))))
                  Sskip))
              (Ssequence
                (Ssequence
                  ...
                  (Sifthenelse (Ebinop One (Etempvar _t'5 tint)
                    ...
                    Sskip))
                (Ssequence
                  (Sassign (Evar _len tuint)
                    (Esizeof (Tstruct _sockaddr_in noattr) tulong))
                  (Ssequence
                    (Ssequence
                      (Scall (Some _t'6)
                        ...
                        ((Etempvar _sockfd_server tint) ::
                         (Ecast
                           (Eaddrof
                             (Evar _client (Tstruct _sockaddr_in noattr))
                             (tptr (Tstruct _sockaddr_in noattr)))
                           (tptr (Tstruct _sockaddr noattr))) ::
                         (Eaddrof (Evar _len tuint) (tptr tuint)) :: nil))
                      (Sset _sockfd_client (Etempvar _t'6 tint)))
                    (Ssequence
                      (Sifthenelse (Ebinop Oeq (Etempvar _sockfd_client tint)
                        ...
                        (Ssequence
                          (Scall None
                            (Evar _puts (Tfunction (Tcons (tptr tschar) Tnil)
                                          tint cc_default))
                            ((Evar ___stringlit_5 (tarray tschar 17)) :: nil))
                          (Sreturn (Some (Econst_int (Int.repr 0) tint))))
                        Sskip)
                      (Ssequence
                        (Sloop
                              ...
                              (Ssequence
                                (Scall (Some _t'7)
                                  ...
                                  ((Etempvar _sockfd_client tint) ::
                                   (Evar _buf (tarray tschar 100)) ::
                                   (Econst_int (Int.repr 100) tint) ::
                                   (Econst_int (Int.repr 0) tint) :: nil))
                                (Sset _k (Ecast (Etempvar _t'7 tlong) tint)))
                              (Ssequence
                                ...
                                (Ssequence
                                  (Sifthenelse (Ebinop Oeq (Etempvar _k tint)
                                    ...
                                    (Ssequence
                                      ...
                                      Sbreak)
                                    Sskip)
                                  (Sifthenelse (Ebinop Ogt (Etempvar _k tint)
                                                 (Econst_int (Int.repr 0) tint)
                                                 tint)
                                    (Ssequence
                                      (Scall None
                                        (Evar _puts (Tfunction
                                                      (Tcons (tptr tschar)
                                                        Tnil) tint
                                                      cc_default))
                                        ((Evar ___stringlit_8 (tarray tschar 17)) ::
                                         nil))
                                      (Ssequence
                                        (Scall None
                                          (Evar _puts (Tfunction
                        ...
                        (Ssequence
                          ...
                          (Ssequence
                            (Scall None
                              (Evar _close (Tfunction (Tcons tint Tnil) tint
                                             cc_default))
                              ((Etempvar _sockfd_server tint) :: nil))
                            (Ssequence
                              (Scall None
                                (Evar _puts (Tfunction
...
((___compcert_va_int32,
 ...
 (_accept,
   Gfun(External (EF_external "accept"
                   (mksignature (AST.Tint :: AST.Tlong :: AST.Tlong :: nil)
                     AST.Tint cc_default))
     (Tcons tint
...
(_main :: _close :: _inet_addr :: _htons :: _accept :: _listen :: _recv ::
 _bind :: _socket :: _puts :: ___builtin_debug ::
