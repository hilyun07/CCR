...
Module Info.
  ...
  Definition source_file := "amisc.c".
...
Definition v___stringlit_2 := {|
  ...
  gvar_init := (Init_int8 (Int.repr 65) :: Init_int8 (Int.repr 66) ::
                Init_int8 (Int.repr 67) :: Init_int8 (Int.repr 0) :: nil);
  gvar_readonly := true;
  gvar_volatile := false
|}.
...
Definition v___stringlit_1 := {|
  ...
  gvar_init := (Init_int8 (Int.repr 73) :: Init_int8 (Int.repr 39) ::
...
Definition v_s := {|
  gvar_info := (tptr tschar);
  gvar_init := (Init_addrof ___stringlit_2 (Ptrofs.repr 0) :: nil);
  gvar_readonly := false;
  gvar_volatile := false
|}.
...
(Ssequence
  (Ssequence
    (Scall None
      ...
      ((Evar _v (tptr tschar)) :: nil))
    (Ssequence
      (Scall None
        (Evar _puts (Tfunction (Tcons (tptr tschar) Tnil) tint cc_default))
        ((Evar _w (tptr tschar)) :: nil))
      (Ssequence
        (Scall None (Evar _g (Tfunction Tnil tvoid cc_default)) nil)
        (Ssequence
          (Scall None
            (Evar _puts (Tfunction (Tcons (tptr tschar) Tnil) tint
                          cc_default)) ((Evar _v (tptr tschar)) :: nil))
          (Ssequence
            (Scall None
              (Evar _puts (Tfunction (Tcons (tptr tschar) Tnil) tint
                            cc_default)) ((Evar _w (tptr tschar)) :: nil))
            (Ssequence
              (Scall None
                (Evar _puts (Tfunction (Tcons (tptr tschar) Tnil) tint
                              cc_default)) ((Evar _s (tptr tschar)) :: nil))
...
((___compcert_va_int32,
 ...
 (_puts,
   Gfun(External (EF_external "puts"
                   (mksignature (AST.Tlong :: nil) AST.Tint cc_default))
     (Tcons (tptr tschar) Tnil) tint cc_default)) :: (_w, Gvar v_w) ::
 (_g,
   Gfun(External (EF_external "g" (mksignature nil AST.Tvoid cc_default))
     Tnil tvoid cc_default)) :: (_v, Gvar v_v) :: (_s, Gvar v_s) ::
 (_main, Gfun(Internal f_main)) :: nil).

Definition public_idents : list ident :=
(_main :: _v :: _g :: _w :: _puts :: ___builtin_debug ::
