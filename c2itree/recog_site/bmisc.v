...
Module Info.
  ...
  Definition source_file := "bmisc.c".
...
Definition f_g := {|
  ...
  fn_body :=
(Ssequence
  (Sassign (Evar _v (tptr tschar)) (Evar ___stringlit_3 (tarray tschar 19)))
  (Ssequence
    (Sassign (Evar _w (tptr tschar))
      (Evar ___stringlit_4 (tarray tschar 19)))
    (Scall None
      (Evar _puts (Tfunction (Tcons (tptr tschar) Tnil) tint cc_default))
      ((Evar _s (tptr tschar)) :: nil))))
|}.
...
((___compcert_va_int32,
 ...
 (_w, Gvar v_w) :: (_s, Gvar v_s) :: (_g, Gfun(Internal f_g)) :: nil).

Definition public_idents : list ident :=
(_g :: _w :: _v :: _puts :: ___builtin_debug ::
