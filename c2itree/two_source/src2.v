...
Definition f_g := {|
  ...
  fn_body :=
(Ssequence
  (Sassign (Evar _v (tptr tschar)) (Evar ___stringlit_2 (tarray tschar 19)))
  (Sassign (Evar _w (tptr tschar)) (Evar ___stringlit_3 (tarray tschar 19))))
|}.
...
(_g :: _w :: _v :: ___builtin_debug :: ___builtin_write32_reversed ::
