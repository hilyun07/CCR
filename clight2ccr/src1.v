...
Definition v___stringlit_2 := {|
  ...
  gvar_init := (Init_int8 (Int.repr 91) :: Init_int8 (Int.repr 109) ::
                Init_int8 (Int.repr 97) :: Init_int8 (Int.repr 105) ::
                Init_int8 (Int.repr 110) :: Init_int8 (Int.repr 93) ::
...
(Ssequence
  (Ssequence
    (Sassign (Evar _t tint) (Econst_int (Int.repr 2) tint))
    (Ssequence
      (Scall None
        (Evar _printf (Tfunction (Tcons (tptr tschar) Tnil) tint
                        {|cc_vararg:=(Some 1); cc_unproto:=false; cc_structret:=false|}))
        ((Evar ___stringlit_1 (tarray tschar 15)) :: (Evar _w tint) :: nil))
      (Ssequence
        (Scall None
          (Evar _printf (Tfunction (Tcons (tptr tschar) Tnil) tint
                          {|cc_vararg:=(Some 1); cc_unproto:=false; cc_structret:=false|}))
          ((Evar ___stringlit_2 (tarray tschar 15)) :: (Evar _v tint) :: nil))
        (Ssequence
          (Ssequence
            (Scall (Some _t'1)
              (Evar _g (Tfunction (Tcons tint Tnil) tint cc_default))
              ((Econst_int (Int.repr 8) tint) :: nil))
            (Sassign (Evar _v tint) (Etempvar _t'1 tint)))
          (Ssequence
            (Sassign (Evar _w tint) (Econst_int (Int.repr 0) tint))
            (Ssequence
              (Scall None
                (Evar _printf (Tfunction (Tcons (tptr tschar) Tnil) tint
                                {|cc_vararg:=(Some 1); cc_unproto:=false; cc_structret:=false|}))
...
((___compcert_va_int32,
 ...
 (_g,
   Gfun(External (EF_external "g"
                   (mksignature (AST.Tint :: nil) AST.Tint cc_default))
     (Tcons tint Tnil) tint cc_default)) :: (_t, Gvar v_t) ::
 (_v, Gvar v_v) :: (_main, Gfun(Internal f_main)) :: nil).

Definition public_idents : list ident :=
(_main :: _v :: _g :: _w :: _printf :: ___builtin_debug ::
