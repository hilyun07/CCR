...
Definition v___stringlit_2 := {|
  ...
  gvar_init := (Init_int8 (Int.repr 91) :: Init_int8 (Int.repr 103) ::
...
Definition f_g := {|
  ...
  fn_body :=
(Ssequence
  (Sassign (Evar _v tint)
    (Ebinop Omul (Etempvar _i tint) (Etempvar _i tint) tint))
  (Ssequence
    (Sassign (Evar _w tint)
      (Ebinop Omul (Ebinop Omul (Etempvar _i tint) (Etempvar _i tint) tint)
        (Etempvar _i tint) tint))
    (Ssequence
      (Scall None
        (Evar _printf (Tfunction (Tcons (tptr tschar) Tnil) tint
                        {|cc_vararg:=(Some 1); cc_unproto:=false; cc_structret:=false|}))
        ((Evar ___stringlit_1 (tarray tschar 12)) :: (Evar _w tint) :: nil))
      (Ssequence
        (Scall None
          (Evar _printf (Tfunction (Tcons (tptr tschar) Tnil) tint
                          {|cc_vararg:=(Some 1); cc_unproto:=false; cc_structret:=false|}))
          ((Evar ___stringlit_2 (tarray tschar 12)) :: (Evar _v tint) :: nil))
        (Sreturn (Some (Evar _v tint)))))))
|}.
...
((___compcert_va_int32,
 ...
 (_printf,
   Gfun(External (EF_external "printf"
     ...
     {|cc_vararg:=(Some 1); cc_unproto:=false; cc_structret:=false|})) ::
 (_v, Gvar v_v) :: (_w, Gvar v_w) :: (_g, Gfun(Internal f_g)) :: nil).

Definition public_idents : list ident :=
(_g :: _w :: _v :: _printf :: ___builtin_debug ::
