  ...
  Proof.
    ...
    - split; i; ss.
      + remove_UBcase; eapply H; et. 
        ...
        * econs 2; try solve [eapply env_match_none; et]. inv MGE.
          hexploit MGE0; et. i. des. apply p2s_inj in H0. clarify.
      + remove_UBcase; eapply step_deref_loc; et; i; sim_red; eapply H; et; econs; et.
        * econs. hexploit env_match_some; et.
        * econs 2; try solve [eapply env_match_none; et]. inv MGE. 
          hexploit MGE0; et. i. des. apply p2s_inj in H1. clarify.
