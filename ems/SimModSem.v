...
Section ADEQUACY.
  ...
  .
  Proof.
    (*** TODO : revise proof to general sk.  *)
    ...
    (* { unfold Sk.extends. eexists. unfold sk_tgt. unfold ModL.add. ss. *)
    (*   erewrite (Sk.add_comm (ModL.sk _) _);auto. rewrite <- SKEQ in SKWF. auto. } *)
