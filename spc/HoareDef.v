...
Section CANCEL.
  ...
  Definition mk_pure (fsb: fspec) := mk_specbody fsb (fun arg => Ret arg).
...
Section SMOD.
  ...
  .
  Proof. ss. rewrite Sk.add_unit_l. et. Qed.
  ...
  Lemma transl_fnsems
    ...
    :
      ...
      (load_fnsems (Sk.canon (Sk.add Sk.unit (sk md))) md (tr0 (Sk.canon (Sk.add Sk.unit (sk md)))))
  .
  Proof.
    unfold Mod.enclose.
    rewrite transl_fnsems_aux. ss. rewrite Sk.add_unit_l. f_equal.
  Qed.
