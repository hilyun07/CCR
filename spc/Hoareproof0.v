...
Section CANCEL.
  ...
  Let sk: Sk.t := Sk.canon (Sk.add Sk.unit (SMod.sk md)).
  ...
  Proof.
    ...
    { Local Transparent ModSem.prog.
      ...
      unfold Mod.wf_bool. destruct Mod.wf_dec; ss; steps.
      Local Opaque ModSem.prog. }
    rename f into main_fsb. hexploit MAINM; et.
    i. des.

    unfold Mod.wf_bool. destruct Mod.wf_dec; ss; steps.
    unfold Mod.wf in *. des.
    destruct Mod.wf_dec; ss; [|exfalso; apply n; econs]; cycle 1.
    ...
    unshelve esplits; et.
    { unfold sk in RWF. rewrite Sk.add_unit_l in RWF. et. }
    steps.
